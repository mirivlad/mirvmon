...
final class LocalizationContractTest extends TestCase
{
    ...
    public static function localizedTemplateProvider(): iterable
    {
        foreach ([
            ...
            'templates/sites/detail.twig',
            'templates/sites/partials/detail-overview.twig',
            'templates/sites/partials/detail-metrics.twig',
            'templates/sites/partials/detail-events.twig',
            'templates/sites/partials/detail-settings.twig',
