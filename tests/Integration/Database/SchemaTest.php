...
final class SchemaTest extends TestCase
{
    ...
    public static function setUpBeforeClass(): void
    {
        ...
        self::assertFileExists(dirname(__DIR__, 3) . '/migrations/022_website_schedule_cursor.sql');
        self::assertFileExists(dirname(__DIR__, 3) . '/migrations/023_windows_installer_download_tokens.sql');
        self::assertFileExists(dirname(__DIR__, 3) . '/migrations/024_observations.sql');
        self::assertFileExists(dirname(__DIR__, 3) . '/migrations/025_observation_episode_semantics.sql');
        self::assertFileExists(dirname(__DIR__, 3) . '/migrations/026_contextual_level_shift.sql');
        self::assertFileExists(dirname(__DIR__, 3) . '/migrations/027_maintenance_notification_deferrals.sql');
        self::assertFileExists(dirname(__DIR__, 3) . '/migrations/028_website_check_job_terminal.sql');
        self::assertFileExists(dirname(__DIR__, 3) . '/migrations/029_public_status_page.sql');
        self::assertFileExists(dirname(__DIR__, 3) . '/migrations/030_observation_assessments.sql');
            ...
            "SELECT table_name
             ...
             WHERE table_schema = 'public'
               AND table_name IN (
                   ...
                   'ingested_samples',
                   'installer_tokens',
                   'windows_installer_download_tokens',
                   'notification_outbox',
    ...
    public function testSampleIdentityAndForeignKeysAreEnforced(): void
    {
        ...
        self::assertSame('10', (string) $foreignKeys);
    }
