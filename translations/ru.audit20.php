...
return [
    ...
    'audit.event.website.created' => 'Создан сайт «{name}».',
    'audit.event.website.updated' => 'Изменены настройки сайта «{name}».',
    'audit.event.website.deleted' => 'Удалён сайт «{name}».',
    'audit.event.website.paused' => 'Мониторинг сайта «{name}» приостановлен.',
    'audit.event.website.resumed' => 'Мониторинг сайта «{name}» возобновлён.',
    'audit.event.website.check_requested' => 'Проверка сайта «{name}» добавлена в очередь.',
