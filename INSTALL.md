...
Например, repository reference `v0.3.4` использует
`MIRVMON_IMAGE=ghcr.io/mirivlad/mirvmon:0.3.4`. После первой публикации
...
```dotenv
MIRVMON_IMAGE=ghcr.io/mirivlad/mirvmon:0.3.4
