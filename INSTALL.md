...
Например, repository reference `v0.3.3` использует
`MIRVMON_IMAGE=ghcr.io/mirivlad/mirvmon:0.3.3`. После первой публикации
...
```dotenv
MIRVMON_IMAGE=ghcr.io/mirivlad/mirvmon:0.3.3
